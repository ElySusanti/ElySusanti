...
city_map = Graph(dict(
    Sibiu=dict(Sibiu=0, Fagaras=99, Rimnicu=80, Pitesti= 143, Craiova=175, Bucharest=232),
    Fagaras=dict(Sibiu=99, Fagaras=0, Rimnicu=81, Pitesti= 82, Craiova=169, Bucharest=211),
    Rimnicu=dict(Sibiu=80, Fagaras=81, Rimnicu=0, Pitesti= 97, Craiova=146, Bucharest=186),
    Pitesti=dict(Sibiu=143, Fagaras=82, Rimnicu=97, Pitesti= 0, Craiova=138, Bucharest=101),
    Craiova=dict(Sibiu=175, Fagaras=169, Rimnicu=146, Pitesti= 138, Craiova=0, Bucharest=152),
    Bucharest=dict(Sibiu=232, Fagaras=211, Rimnicu=186, Pitesti= 101, Craiova=152, Bucharest=0)),
    directed=False)
